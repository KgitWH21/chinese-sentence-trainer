...
export default function App() {
  ...
  return <main>
    ...
    <section id="top" className="hero">
      <div className="hero-copy"><p className="eyebrow">DAILY CONSTRUCTION PRACTICE · {displayChinese("每日造句", script)}</p><h1>Build one sentence.<br/><em>Write great Chinese.</em></h1><p>Draw a starter, a grammar construction, an ending, and a word. Write your way to fluency.</p></div>
